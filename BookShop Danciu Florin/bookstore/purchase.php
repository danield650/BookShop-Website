...
?>
	...
	<form method="post" action="process.php" class="form-horizontal">
        ...
        <div class="form-group">
            <label for="card_number" class="col-lg-2 control-label">Nr Card</label>
            <div class="col-lg-10">
        ...
        <div class="form-group">
            <label for="card_owner" class="col-lg-2 control-label">Nume</label>
            <div class="col-lg-10">
        ...
        <div class="form-group">
            <div class="col-lg-10 col-lg-offset-2">
              	<button type="reset" class="btn btn-default">Inapoi</button>
              	<button type="submit" class="btn btn-primary">Cumpara!</button>
            </div>
        </div>
    </form>
	<p class="lead">Apasa Cumpara! pentru confirmare, sau Inapoi pentru a mai adauga carti.</p>
<?php
	} else {
